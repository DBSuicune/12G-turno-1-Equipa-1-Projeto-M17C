<?php 
	...
	Inner JOIN product_photo ON products.id = product_photo.product_id Where products.id = $id ";
	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Pagina de detalhes de produto</h1>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/products/<?php echo $product['photo'] ?>" alt="">
						</div>						
						<div class="single-prd-item">
							<img class="img-fluid" src="img/products/<?php echo $product['photo'] ?>" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						$sql_category = "SELECT category.Name FROM category 
						INNER JOIN product_category ON category.id = product_category.category_id 
						INNER JOIN products ON product_category.products_id = products.id
						...
						echo '<ul class="list">';
						echo '	<li><a class="active" href="#"><span>Category</span> :';
						...
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn" href="#" onclick="add_item_cart(<?php echo $product['id'] ?>)">Add to Cart</a>
						</div>
					</div>
				</div>
			</div>
